...
import (
	...
	"github.com/mark3labs/mcp-go/pkg/tool"
...
func MockGetContentsNotFound(
	...
	mockedHTTPClient.Register(
		...
		mock.JSONBody(github.ErrorResponse{
			Message: "Not Found",
		}),
	)
}
